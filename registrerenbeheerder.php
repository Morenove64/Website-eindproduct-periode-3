...
if(isset($_POST["registreren"]))
{
    try
    {
        if($_POST['wachtwoord1']==$_POST['wachtwoord2'])
        {
            ...
            $sQuery = "INSERT INTO beheerder (voornaam, achternaam, email, wachtwoord) VALUES (:voornaam, :achternaam, :email, :wachtwoord)";
            ...
            echo "Uw Beheerderid is: " .$db->LastInsertId();
        }
        else
        {
            echo "Wachtwoorden zijn niet gelijk";
        }
        header('Refresh: 10; url=registrerenbeheerderform.php');
    }
